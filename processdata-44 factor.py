...
if __name__ == "__main__":  
    ...
    path='C:/Users/Xuwen/Documents/data_tool/data_demo'            
    Factor=GetData(path,method='SoverT')  #Stock Over Time
    Factor.to_csv('train.csv',header=True,index=False)
    
'2008'>'2009'

c_train=Factor[Factor.Date>'20080122']
C_train=c_train.rename(columns={'Date':'tdate'})